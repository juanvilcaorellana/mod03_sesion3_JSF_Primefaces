...
public class GestionCategorias {
	...
	static {
		categorias.add(new Categoria(1, "Electrónica","objetos electronicos"));
		categorias.add(new Categoria(2, "Libros","libros nacionale e internacionales"));
		categorias.add(new Categoria(3, "Deportes","todos los deportes"));
	}
